...
class BookshelfState extends State<BookshelfScene> with RouteAware {
  ...
  void initState() {
    super.initState();
    /// See commented fetchData function
    // fetchData();
  ...
  /// Commented by Jinchao, Don't need to fetch data now
  /*
  ...
  */
  ...
  Widget buildFavoriteView() {
    ...
    novels.forEach((novel) {
      ...
      children.add(Text("BookShelfItemView"));
    });
    var width = (Screen.width - 15 * 2 - 24 * 2) / 3;
    children.add(GestureDetector(
      onTap: () {
        /// Don't know eventBus is userd for
